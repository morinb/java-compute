...
public enum Operator {
		...
		public String compute(String... args)
			...
			if (args == null) {
				throw new MathematicalAnalysisException(
						"ADDITION: Args must not be null");
			}
			if (args.length != nbArgs) {
				throw new MathematicalAnalysisException(
						"ADDITION: function needs " + nbArgs
								+ " exactly argument(s).");
			}
	...
	SUBSTRACTION("-", 10, true, 2, new DelegateFunction(2) {
		...
		public String compute(String... args)
			...
			if (args == null) {
				throw new MathematicalAnalysisException(
						"SUBSTRACTION: Args must not be null");
			}
			if (args.length != nbArgs) {
				throw new MathematicalAnalysisException(
						"SUBSTRACTION: function needs " + nbArgs
								+ " exactly argument(s).");
			}
	...
	MULTIPLICATION("*", 100, true, 2, new DelegateFunction(2) {
		...
		public String compute(String... args)
			...
			if (args == null) {
				throw new MathematicalAnalysisException(
						"MULTIPLICATION: Args must not be null");
			}
			if (args.length != nbArgs) {
				throw new MathematicalAnalysisException(
						"MULTIPLICATION: function needs " + nbArgs
								+ " exactly argument(s).");
			}
	...
	DIVISION("/", 100, true, 2, new DelegateFunction(2) {
		...
		public String compute(String... args)
			...
			if (args == null) {
				throw new MathematicalAnalysisException(
						"DIVISION: Args must not be null");
			}
			if (args.length != nbArgs) {
				throw new MathematicalAnalysisException(
						"DIVISION: function needs " + nbArgs
								+ " exactly argument(s).");
			}
	...
	POWER("^", 1000, false, 2, new DelegateFunction(2) {
		...
		public String compute(String... args)
			...
			if (args == null) {
				throw new MathematicalAnalysisException(
						"POWER: Args must not be null");
			}
			if (args.length != nbArgs) {
				throw new MathematicalAnalysisException(
						"POWER: function needs " + nbArgs
								+ " exactly argument(s).");
			}
	...
	private Operator(String valeur, int priorite, boolean leftAssociative,
			int nbArgs, DelegateFunction delegate) {
		this.value = valeur;
