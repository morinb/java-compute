...
public enum Function {
	...
	SQRT("sqrt", 1, new DelegateFunction(1) {
		...
		public String compute(String... args) {
			...
			if (args.length != nbArgs) {
				throw new IllegalArgumentException("SQRT: function needs "
						+ nbArgs + " exactly argument(s).");
			}
	...
	LOG("log", 1, new DelegateFunction(1) {
		...
		public String compute(String... args) {
			...
			if (args.length != nbArgs) {
				throw new IllegalArgumentException("LOG: function needs "
						+ nbArgs + " exactly argument(s).");
			}
	...
	EXP("exp", 1, new DelegateFunction(1) {
		...
		public String compute(String... args) {
			...
			if (args.length != nbArgs) {
				throw new IllegalArgumentException("EXP: function needs "
						+ nbArgs + " exactly argument(s).");
			}
